...
- (void)liveSession:(nullable LFLiveSession *)session liveStateDidChange:(LFLiveState)state{
    ...
    CGRect labelFrame = [_stateLabel frame];
    labelFrame.size.width = _stateLabel.intrinsicContentSize.width;
    [_stateLabel setFrame:labelFrame];
}
...
- (UIButton*)cameraButton{
    if(!_cameraButton){
        ...
        [_cameraButton setImage:[UIImage imageNamed:@"camera_preview"] forState:UIControlStateNormal];
...
- (UIButton*)beautyButton{
    if(!_beautyButton){
        ...
        [_beautyButton setImage:[UIImage imageNamed:@"camera_beauty"] forState:UIControlStateSelected];
        [_beautyButton setImage:[UIImage imageNamed:@"camera_beauty_close"] forState:UIControlStateNormal];
